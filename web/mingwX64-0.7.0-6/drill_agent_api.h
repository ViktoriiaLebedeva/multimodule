...
typedef struct {
  drill_agent_KNativePtr pinned;
} drill_agent_kref_com_epam_drill_plugin_api_SerDe;
typedef struct {
  drill_agent_KNativePtr pinned;
...
extern void* getJvm();
extern void* jvmtii();
extern void Java_com_epam_drill_plugin_api_processing_Sender_sendMessage(void* envs, void* thiz, void* jpluginId, void* jmessage);
          ...
          struct {
            ...
            struct {
              ...
              struct {
                ...
                drill_agent_kref_com_epam_drill_agent_AgentArguments (*AgentArguments)(drill_agent_KInt seen1, const char* agentId, const char* adminAddress, const char* drillInstallationDir, const char* buildVersion, const char* instanceId, const char* groupId, const char* logLevel, const char* logFile, drill_agent_KBoolean isWebApp, drill_agent_KBoolean isAsyncApp, const char* webAppNames, drill_agent_KLong classScanDelay, drill_agent_kref_kotlinx_serialization_SerializationConstructorMarker serializationConstructorMarker);
                drill_agent_kref_com_epam_drill_agent_AgentArguments (*AgentArguments_)(const char* agentId, const char* adminAddress, const char* drillInstallationDir, const char* buildVersion, const char* instanceId, const char* groupId, const char* logLevel, const char* logFile, drill_agent_KBoolean isWebApp, drill_agent_KBoolean isAsyncApp, const char* webAppNames, drill_agent_KLong classScanDelay);
                ...
                const char* (*component11)(drill_agent_kref_com_epam_drill_agent_AgentArguments thiz);
                drill_agent_KLong (*component12)(drill_agent_kref_com_epam_drill_agent_AgentArguments thiz);
                ...
                drill_agent_kref_com_epam_drill_agent_AgentArguments (*copy)(drill_agent_kref_com_epam_drill_agent_AgentArguments thiz, const char* agentId, const char* adminAddress, const char* drillInstallationDir, const char* buildVersion, const char* instanceId, const char* groupId, const char* logLevel, const char* logFile, drill_agent_KBoolean isWebApp, drill_agent_KBoolean isAsyncApp, const char* webAppNames, drill_agent_KLong classScanDelay);
                ...
                struct {
                  ...
                  drill_agent_kref_kotlinx_serialization_SerialDescriptor (*get_descriptor)(drill_agent_kref_com_epam_drill_agent_AgentArguments_$serializer thiz);
                  drill_agent_kref_kotlin_Array (*childSerializers)(drill_agent_kref_com_epam_drill_agent_AgentArguments_$serializer thiz);
                  drill_agent_kref_com_epam_drill_agent_AgentArguments (*deserialize)(drill_agent_kref_com_epam_drill_agent_AgentArguments_$serializer thiz, drill_agent_kref_kotlinx_serialization_Decoder decoder);
                  void (*serialize)(drill_agent_kref_com_epam_drill_agent_AgentArguments_$serializer thiz, drill_agent_kref_kotlinx_serialization_Encoder encoder, drill_agent_kref_com_epam_drill_agent_AgentArguments value);
                } $serializer;
                struct {
                  drill_agent_KType* (*_type)(void);
              ...
              struct {
                drill_agent_KType* (*_type)(void);
                drill_agent_kref_com_epam_drill_agent_Config (*Config)(drill_agent_KDouble classScanDelay, drill_agent_KBoolean isAsyncApp, drill_agent_KBoolean isWebApp, drill_agent_KDouble webAppLoadingTimeout, drill_agent_kref_kotlin_collections_List webApps);
                ...
                drill_agent_KDouble (*component4)(drill_agent_kref_com_epam_drill_agent_Config thiz);
                drill_agent_kref_kotlin_collections_List (*component5)(drill_agent_kref_com_epam_drill_agent_Config thiz);
                drill_agent_kref_com_epam_drill_agent_Config (*copy)(drill_agent_kref_com_epam_drill_agent_Config thiz, drill_agent_KDouble classScanDelay, drill_agent_KBoolean isAsyncApp, drill_agent_KBoolean isWebApp, drill_agent_KDouble webAppLoadingTimeout, drill_agent_kref_kotlin_collections_List webApps);
              ...
              struct {
                struct {
                  drill_agent_KType* (*_type)(void);
                  drill_agent_kref_com_epam_drill_agent_serialization_SimpleMapDecoder (*SimpleMapDecoder)(drill_agent_kref_kotlin_collections_Map map);
                  drill_agent_KInt (*decodeElementIndex)(drill_agent_kref_com_epam_drill_agent_serialization_SimpleMapDecoder thiz, drill_agent_kref_kotlinx_serialization_SerialDescriptor descriptor);
              ...
              struct {
                struct {
                  ...
                  struct {
                    ...
                    drill_agent_kref_kotlinx_serialization_KSerializer (*get_confSerializer)(drill_agent_kref_com_epam_drill_core_plugin_loader_GenericNativePlugin thiz);
                    ...
                    drill_agent_kref_com_epam_drill_plugin_api_SerDe (*get_serDe)(drill_agent_kref_com_epam_drill_core_plugin_loader_GenericNativePlugin thiz);
            ...
            struct {
              struct {
                ...
                void (*setAsyncMode)(drill_agent_kref_com_epam_drill_request_RequestHolder thiz, drill_agent_KBoolean isAsync);
              ...
              struct {
                ...
                void (*setAsyncMode)(drill_agent_kref_com_epam_drill_request_RequestHolderStub thiz, drill_agent_KBoolean isAsync);
                void (*store)(drill_agent_kref_com_epam_drill_request_RequestHolderStub thiz, drill_agent_kref_kotlin_ByteArray drillRequest);
